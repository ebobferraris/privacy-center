...
const translations = {
  "de": {
    "ui": {
      ...
      "chooseLanguage": "Wählen Sie die Sprache, in der Sie die {app}-Datenschutzhinweis anzeigen möchten:",
      "mainLanguage": "Hauptsprache",
      "translation": "Übersetzung",
      "viewInItalian": "Auf Italienisch anzeigen",
      "viewInEnglish": "Auf Englisch anzeigen",
      "viewInFrench": "Auf Französisch anzeigen",
      ...
      "viewInFr": "Auf Französisch anzeigen",
      ...
      "contentNotAvailable": "Inhalt der Mitteilung nicht verfügbar.",
      "availablePrivacyNotices": "Verfügbare Datenschutzhinweise",
      ...
      "outdatedTranslationText": "Diese Übersetzung basiert auf einer älteren Version als der italienischen Version. Neueste italienische Version anzeigen",
  ...
  "fr": {
    "ui": {
      ...
      "chooseLanguage": "Choisissez la langue dans laquelle vous souhaitez consulter l'avis de confidentialité {app} :",
      "mainLanguage": "Langue principale",
      "translation": "Traduction",
      "viewInItalian": "Voir en italien",
      "viewInEnglish": "Voir en anglais",
      "viewInFrench": "Voir en français",
      "viewInGerman": "Voir en allemand",
      "viewInSlovenian": "Voir en slovène",
      "viewInIt": "Voir en Italien",
      "viewInEn": "Voir en Anglais",
      "viewInFr": "Voir en Français",
      "viewInDe": "Voir en Allemand",
      "viewInSl": "Voir en Slovène",
      "currentLang": "🇫🇷 FR",
      ...
      "whatsNew": "Nouveautés dans la version {version}",
      "contentNotAvailable": "Contenu de l'avis non disponible.",
      "availablePrivacyNotices": "Avis de Confidentialité Disponibles",
      "archivedVersion": "Version Archivée {version}",
      "archivedVersionText": "Ceci est une version archivée de l'avis de confidentialité. Voir la dernière version",
      "viewLatestVersion": "Voir la dernière version",
      "outdatedTranslation": "Traduction Obsolète",
      "outdatedTranslationText": "Cette traduction est basée sur une version plus ancienne que la version italienne. Voir la dernière version italienne",
      "viewLatestItalianVersion": "Voir la dernière version italienne",
      "latestVersion": "{version} (dernière)"
    },
    "warnings": {
  ...
  "it": {
    "ui": {
      ...
      "whatsNew": "Novità nella versione {version}",
      ...
      "archivedVersionText": "Questa è una versione archiviata dell'informativa privacy. Visualizza versione più recente",
      "viewLatestVersion": "Visualizza versione più recente",
      "outdatedTranslation": "Traduzione Obsoleta",
      "outdatedTranslationText": "Questa traduzione è basata su una versione più vecchia rispetto alla versione italiana. Visualizza ultima versione italiana",
      "viewLatestItalianVersion": "Visualizza ultima versione italiana",
      "latestVersion": "{version} (più recente)"
    },
    "warnings": {
  ...
  "sl": {
    "ui": {
      ...
      "chooseLanguage": "Izberite jezik, v katerem želite pregledati obvestilo o zasebnosti {app}:",
      "mainLanguage": "Glavni jezik",
      "translation": "Prevod",
      "viewInItalian": "Ogled v italijanščini",
      "viewInEnglish": "Ogled v angleščini",
      "viewInFrench": "Ogled v francoščini",
      "viewInGerman": "Ogled v nemščini",
      "viewInSlovenian": "Ogled v slovenščini",
      "viewInIt": "Prikaži v Italijanščini",
      "viewInEn": "Prikaži v Angleščini",
      "viewInFr": "Prikaži v Francoščini",
      "viewInDe": "Prikaži v Nemščini",
      "viewInSl": "Prikaži v Slovenščini",
      "currentLang": "🇸🇮 SL",
      ...
      "whatsNew": "Kaj je novega v različici {version}",
      "contentNotAvailable": "Vsebina obvestila ni na voljo.",
      "availablePrivacyNotices": "Razpoložljiva Obvestila o Zasebnosti",
      "archivedVersion": "Arhivirana Različica {version}",
      "archivedVersionText": "To je arhivirana različica obvestila o zasebnosti. Prikaži najnovejšo različico",
      "viewLatestVersion": "Prikaži najnovejšo različico",
      "outdatedTranslation": "Zastarel Prevod",
      "outdatedTranslationText": "Ta prevod temelji na starejši različici kot italijanska različica. Prikaži najnovejšo italijansko različico",
      "viewLatestItalianVersion": "Prikaži najnovejšo italijansko različico",
      "latestVersion": "{version} (najnovejša)"
    },
    "warnings": {
